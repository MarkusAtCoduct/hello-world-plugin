 ...
 */
const myMappingDatabase = new Map();
...
async function verifySessionTokenAndExtractPayload(sessionToken) {
    // Fetch the JWKS
...
export async function getJwt() {
    ...
    const response = await fetch(`https://auth${Environment}.jtl-cloud.com/oauth2/token`, {
        method: "POST",
        headers: {
...
app.all("/erp-info/:tenantId/:endpoint", async (req, res) => {
    try {
